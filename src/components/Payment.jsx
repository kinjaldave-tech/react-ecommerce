							...
							<div id="tab4" className="tab-grid" style="display: block;">
								<div className="row">
									<div className="col-md-6 pay-forms">
										<img className="pp-img" to="assets/images/paypal.png" alt="Image Alternative text" title="Image Title"/>
					...
					<div className="join-agile text-left p-4">
						<div className="row">
							...
							<div className="col-sm-5 offerimg-w3l">
								<img to="assets/images/off1.png" alt="" className="img-fluid"/>
							</div>
						</div>
					</div>
				</div>
				<div className="col-lg-6 mt-lg-0 mt-5">
					<div className="join-agile text-left p-4">
						<div className="row ">
							...
							<div className="col-sm-5 offerimg-w3l">
								<img to="assets/images/off2.png" alt="" className="img-fluid"/>
							</div>
						</div>
					</div>
				</div>
